...
namespace MyGame_II
{
    public partial class Form1 : Form
    {
        ...
        {
            double range = (double)powerBar.Value / powerBar.Maximum;
        ...
        {
            powerBar.Step = 1 * (reverse ? -1 : 1);
            powerBar.PerformStep();
            if (powerBar.Value == powerBar.Minimum || powerBar.Value == powerBar.Maximum)
            {
                reverse = !reverse;
            }
        }
        ...
        private void showConsole()
        {
            ...
            if (ballPic.Left > ringPic.Left-10 && ballPic.Right < ringPic.Right+10)
            {
